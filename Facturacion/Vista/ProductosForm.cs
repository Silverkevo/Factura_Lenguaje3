    ...
    public partial class ProductosForm : Syncfusion.Windows.Forms.Office2010Form
    {
        ...
        private void GuardarButton_Click(object sender, EventArgs e)
        {
            if (operacion == "Nuevo")
            {
                ...
                //Insertamos en la base de datos DB

                producto.Codigo = CodigoTextBox.Text;
                producto.Descripcion = DescripcionTextBox.Text;
                producto.Exisencia = Convert.ToInt32(ExistenciaTextBox.Text);
        ...
        private void ExistenciaTextBox_KeyPress(object sender, System.Windows.Forms.KeyPressEventArgs e)
        {
            ...
            {
                e.Handled = true;
                errorProvider1.SetError(ExistenciaTextBox, "Ingrese solo valores numericos");
            }
        ...
        private void PrecioTextBox_KeyPress(object sender, System.Windows.Forms.KeyPressEventArgs e)
        {
            ...
            {
                e.Handled = true;
                errorProvider1.SetError(PrecioTextBox, "Ingrese solo valores numericos");
        ...
        private void EliminarButton_Click(object sender, EventArgs e)
        {
            if (ProductosDataGridView.SelectedRows.Count > 0)
            {
                ...
                DialogResult dialogResult = MessageBox.Show("¿Seguro de eliminar el registro?", "Adevertencia", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
